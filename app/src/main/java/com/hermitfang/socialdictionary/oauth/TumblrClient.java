package com.hermitfang.socialdictionary.oauth;
...
public class TumblrClient extends OAuthBaseClient {
    ...
    public static final String REST_CALLBACK_URL = "oauth://yDictionary";
    ...
    public void createPhotoPost(String blog, File file, AsyncHttpResponseHandler handler) {
        ...
        client.post(getApiUrl(String.format("blog/%s/post?type=photo&tags=yDictionary", blog)), params, handler);
    }

    public void createPhotoPost(String blog, Bitmap bitmap, String caption, final AsyncHttpResponseHandler handler) {
        RequestParams params = new RequestParams();
        params.put("type", "photo");
        params.put("tags", "yDictionary");
    ...
    public void editPhotoPostCaption(String blog, long id, String caption, final AsyncHttpResponseHandler handler) {
        RequestParams params = new RequestParams();
        params.put("id", id);
        params.put("caption", caption);
        client.post(getApiUrl(String.format("blog/%s/post/edit?type=photo", blog)), params, handler);
    }
}